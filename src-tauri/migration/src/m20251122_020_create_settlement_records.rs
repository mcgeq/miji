                ...
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(SettlementRecords::SettlementType)
                            .string_len(20)
                            .not_null()
                            .check(Expr::col(SettlementRecords::SettlementType).is_in(vec![
                                "Manual",
                                "Automatic",
                                "Partial",
                                "Full",
                    ...
                    .col(
                        ColumnDef::new(SettlementRecords::Status)
                            ...
                            .not_null()
                            .default("Pending")
                            .check(Expr::col(SettlementRecords::Status).is_in(vec![
                                "Pending",
                                "InProgress",
                                "Completed",
                                "Cancelled",
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_settlement_ledger")
                            .from(
                                SettlementRecords::Table,
                                SettlementRecords::FamilyLedgerSerialNum,
                            )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_settlement_initiated_by")
