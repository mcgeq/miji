...
mod m20250527_000002_create_money_account;
mod m20250527_000003_create_money_transaction;
mod m20250527_000004_create_money_currency;
mod m20250527_000005_create_money_budget;
mod m20250527_000006_create_money_family_ledger;
mod m20250527_000007_create_money_bill_reminder;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250527_000002_create_money_account::Migration),
            Box::new(m20250527_000003_create_money_transaction::Migration),
            Box::new(m20250527_000004_create_money_currency::Migration),
            Box::new(m20250527_000005_create_money_budget::Migration),
            Box::new(m20250527_000006_create_money_family_ledger::Migration),
            Box::new(m20250527_000007_create_money_bill_reminder::Migration),
        ]
    }
}
