...
abstract class AppLocalizations {
  ...
  /// Label for the Home navigation item and page title
  ///
  /// In en, this message translates to:
  /// **'Home'**
  String get home;

  /// Label for the Profile navigation item and page title
  ///
  /// In en, this message translates to:
  /// **'Profile'**
  String get profile;

  /// Label for the Settings navigation item and page title
  ///
  /// In en, this message translates to:
  /// **'Settings'**
  String get settings;

  /// Label for the menu header in the drawer
  ///
  /// In en, this message translates to:
  /// **'Menu'**
  String get menu;

  /// Description text for the profile page
  ///
  /// In en, this message translates to:
  ...
  /// Label for the delete todo button
  ///
  /// In en, this message translates to:
  /// **'Delete'**
