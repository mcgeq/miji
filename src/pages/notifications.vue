    ...
    <Card>
      ...
      <div v-else class="flex flex-col gap-4">
        ...
        >
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex items-center space-x-4 text-xs text-gray-400 dark:text-gray-500">
                ...
                <Badge :color="getPriorityColor(log.priority)" size="sm">{{ log.priority }}</Badge>
              </div>
            </div>
            ...
            <div class="flex gap-2">
              ...
              <Button variant="ghost" size="sm" @click.stop="handleDelete(log.id)">
          ...
          <div
            v-if="log.error"
            class="flex items-center mt-2 p-2 bg-red-50 dark:bg-red-900/20 rounded border border-red-200 dark:border-red-800"
          >
