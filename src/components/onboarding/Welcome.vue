  ...
  <div class="welcome-onboarding">
    ...
    <div v-if="currentStep === 0" class="onboarding-step">
      <div class="step-content">
        ...
        <p class="step-description">一个功能强大的个人管理应用，帮助您更好地管理生活</p>
    ...
    <div v-if="currentStep === 1" class="onboarding-step">
      <div class="step-content">
        ...
        <p class="step-description">及时提醒您的重要事项，不错过任何待办和账单</p>
      ...
      <div class="step-actions">
        <Button variant="outline" @click="skipPermission" title="稍后设置" class="icon-only-button">
    ...
    <div v-if="currentStep === 2" class="onboarding-step">
      <div class="step-content">
        ...
        <p class="step-description">您已完成初始设置，现在可以开始使用觅记了</p>
