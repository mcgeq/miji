...
<template>
  <div class="relative w-full">
    ...
    <textarea
      ...
      class="w-full rounded-lg border transition-colors resize-y focus:outline-none focus:ring-2 px-4 py-2 text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 scrollbar-hide"
      :class="[
        error
