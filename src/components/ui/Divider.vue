...
<template>
  ...
  >
    ...
    <div
      ...
      class="flex-1 border-t border-gray-200 dark:border-gray-700" :class="[
    ...
    <div
      v-if="$slots.default"
      class="text-sm text-gray-500 dark:text-gray-400" :class="[
  ...
  <div
    v-else
    class="inline-block h-full border-l border-gray-200 dark:border-gray-700" :class="[
      variantClasses[variant],
      spacing === 'sm' && 'mx-2',
      spacing === 'md' && 'mx-4',
      spacing === 'lg' && 'mx-8',
