...
<template>
  <HSwitch
    ...
    :disabled="disabled"
    class="relative inline-flex shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    :class="[
  ...
  <div v-if="label || description" class="ml-3 inline-block align-middle">
    <p v-if="label" class="text-sm font-medium text-gray-900 dark:text-white">{{ label }}</p>
