...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="relative flex cursor-pointer rounded-lg px-4 py-3 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" :class="[
            checked
        ...
        >
          <div class="flex w-full items-center justify-between">
            <div class="flex items-center gap-3">
              <!-- 自定义单选框 -->
              <div
                class="rounded-full border-2 flex items-center justify-center transition-all" :class="[
              ...
              >
                <div
                  v-if="checked"
                  class="rounded-full bg-white" :class="[sizeConfig[size].dot]"
                />
              </div>
