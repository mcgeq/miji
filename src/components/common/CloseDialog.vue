    ...
    try {
      ...
      if (rememberChoice.value) {
        ...
        window.dispatchEvent(
          new CustomEvent('close-preference-changed', {
        ...
        >
          ...
          >
            ...
            <div class="px-6 pt-6 pb-4 text-center">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">关闭应用</h3>
              <p class="text-sm text-gray-600 dark:text-gray-400">选择您希望的操作</p>
            </div>
            ...
            <div class="px-6 pb-6">
              ...
              <div class="mb-6 flex justify-center">
                <Checkbox v-model="rememberChoice" label="记住我的选择" />
              </div>
