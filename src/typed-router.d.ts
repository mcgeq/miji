...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dictionaries': RouteRecordInfo<'dictionaries', '/dictionaries', Record<never, never>, Record<never, never>>,
    ...
    'money': RouteRecordInfo<'money', '/money', Record<never, never>, Record<never, never>, '/money/budget-allocations' | 'members' | 'money-debt-relations' | 'money-settlement-records' | 'money-settlement-suggestion' | 'split-records' | 'split-templates' | 'statistics'>,
    '/money/budget-allocations': RouteRecordInfo<'/money/budget-allocations', '/money/budget-allocations', Record<never, never>, Record<never, never>>,
    'money-debt-relations': RouteRecordInfo<'money-debt-relations', '/money/debt-relations', Record<never, never>, Record<never, never>>,
    'members': RouteRecordInfo<'members', '/money/members', Record<never, never>, Record<never, never>>,
    'money-settlement-records': RouteRecordInfo<'money-settlement-records', '/money/settlement-records', Record<never, never>, Record<never, never>>,
    'money-settlement-suggestion': RouteRecordInfo<'money-settlement-suggestion', '/money/settlement-suggestion', Record<never, never>, Record<never, never>>,
