    ...
    <form @submit.prevent="saveMember">
      ...
      <div v-if="!props.member && memberMode === 'select_member'" class="mb-6">
        ...
        <div class="flex items-center gap-4">
          <label class="text-sm font-medium text-gray-900 dark:text-white min-w-[6rem] shrink-0">
            搜索成员
          </label>
      ...
      <div v-if="props.member || memberMode === 'create_member'" class="mb-6">
        ...
        <div v-if="selectedExistingMember" class="mb-4 flex items-center gap-4">
          ...
          <div
            class="flex items-center gap-3 flex-1 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-500 dark:border-blue-600 rounded-xl"
          >
            <div class="w-10 h-10 rounded-full overflow-hidden shrink-0 shadow-sm">
              ...
              <div
                ...
                :style="{ backgroundColor: selectedExistingMember.color || '#3b82f6' }"
              >
      ...
      <div class="mb-6">
        ...
        <FormRow label="头像URL" optional>
          <Input v-model="form.avatar" type="url" placeholder="请输入头像URL（可选）" />
        </FormRow>
        ...
        <FormRow label="预览" optional>
          <div
            class="flex items-center gap-3 p-4 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 flex-1"
          >
            <div
            ...
            >
              <img
                ...
                class="w-full h-full object-cover"
              />
              <span v-else class="text-base"> {{ form.name.charAt(0).toUpperCase() || 'A' }}</span>
            </div>
