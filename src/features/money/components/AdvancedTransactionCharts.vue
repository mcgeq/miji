  ...
  <div class="mb-8">
    <Card shadow="md" padding="lg">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">收支趋势分析</h3>
        ...
        <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
          ...
          <!-- 净收入开关 -->
          <Switch v-model="showNetIncome" label="显示净收入" />
        </div>
      </div>
      ...
      <div class="min-h-[300px] sm:min-h-[400px]">
        ...
        <div
          v-if="loading"
          class="flex flex-col items-center justify-center h-[300px] sm:h-[400px] gap-4"
        >
          <Spinner size="lg" />
