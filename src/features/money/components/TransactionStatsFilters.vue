<script setup lang="ts">
  ...
  type Emits = (e: 'change', filters: Filters) => void;
  ...
  >
    ...
    <div class="hidden md:block">
      ...
      <div class="flex items-center gap-2 flex-wrap">
        ...
        <!-- 重置按钮 -->
        <Button variant="secondary" size="xs" @click="resetFilters">重置</Button>
      </div>
    </div>
    ...
    <div class="block md:hidden">
      ...
      <div class="flex items-center gap-2 flex-wrap justify-center">
        ...
        <Button variant="secondary" size="xs" class="flex-1 min-w-0" @click="resetFilters">
          重置
        </Button>
      </div>
    </div>
