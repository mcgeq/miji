<script setup lang="ts">
  ...
  function addParticipant() {
    const availableMembers = members.value.filter(
      member => !form.participants.some(p => p.memberSerialNum === member.serialNum),
    );
...
<template>
  <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-[1000]">
    <div
      class="bg-white dark:bg-gray-800 rounded-lg w-[90%] max-w-[600px] max-h-[90vh] overflow-hidden flex flex-col"
    >
      <div
      ...
      <div class="flex-1 overflow-y-auto px-6 py-4">
        ...
        <div class="mb-6">
          <div class="flex items-center justify-between mb-4">
            <h4 class="text-base font-semibold text-gray-900 dark:text-white">参与者配置</h4>
            <button
              type="button"
            ...
            >
              <div class="flex items-center gap-2 flex-1">
                ...
                <span class="font-medium text-gray-900 dark:text-white"
                  >{{ getMemberName(participant.memberSerialNum) }}</span
                >
              </div>
        ...
        <div class="mb-6">
          <div class="flex items-center justify-between mb-4">
            <h4 class="text-base font-semibold text-gray-900 dark:text-white">预览</h4>
          ...
          <div class="flex flex-col gap-2">
            ...
            >
              ...
              <span class="font-semibold text-emerald-600 dark:text-emerald-400"
                >{{ result.amount.toFixed(2) }}元</span
              >
      ...
      <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
        ...
        <Button variant="primary" @click="saveRule">保存</Button>
      </div>
    </div>
  </div>
</template>
