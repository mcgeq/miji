...
<template>
  <div class="p-4">
    ...
    <div class="flex items-center justify-between mb-6">
      <h3 class="text-xl font-semibold text-gray-900 dark:text-white">财务统计</h3>
    ...
    <div v-else-if="stats" class="flex flex-col gap-6">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card padding="md" hoverable>
          <div class="flex items-start gap-3">
            <div
              class="p-1.5 rounded-lg bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400"
              title="总收入"
            >
            ...
            <div class="flex-1 min-w-0">
              <div
                class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white break-all"
              >
        ...
        <Card padding="md" hoverable>
          <div class="flex items-start gap-3">
            <div
              class="p-1.5 rounded-lg bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400"
              title="总支出"
            >
        ...
        <Card padding="md" hoverable>
          <div class="flex items-start gap-3">
            <div
              class="p-1.5 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400"
              title="净余额"
            >
        ...
        <Card padding="md" hoverable>
          <div class="flex items-start gap-3">
            <div
              class="p-1.5 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 text-yellow-500 dark:text-yellow-400"
              title="待结算"
            >
              <LucideClock :size="20" />
            </div>
      ...
      <!-- 活动统计 -->
      <Card padding="lg">
        <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">活动统计</h4>
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-md">
            ...
            <div class="flex-1">
              ...
              <div class="text-xs text-gray-500 dark:text-gray-400">活跃成员</div>
            </div>
          </div>
          <div class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-md">
            ...
            <div class="flex-1">
              ...
              <div class="text-xs text-gray-500 dark:text-gray-400">交易笔数</div>
            </div>
          </div>
          <div class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-md">
            ...
            <div class="flex-1">
              ...
              <div class="text-xs text-gray-500 dark:text-gray-400">分摆记录</div>
            </div>
          </div>
        </div>
      </Card>
    ...
    <div v-else class="flex flex-col items-center justify-center py-12 text-center">
      ...
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">暂无统计数据</h3>
      <p class="text-gray-500 dark:text-gray-400">当前时间段内没有财务数据</p>
    </div>
  </div>
</template>
