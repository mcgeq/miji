...
<template>
  <div v-if="!showingDetail" class="flex flex-col w-full min-h-screen p-5 box-border">
    <!-- 头部 -->
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700 gap-3 md:gap-0">
