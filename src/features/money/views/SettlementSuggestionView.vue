  ...
  <div class="p-6 flex flex-col gap-6">
    ...
    <div class="flex flex-col md:flex-row items-start justify-between gap-4">
      <div class="flex items-start gap-3">
        <button class="p-2 rounded-lg transition-colors text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" @click="handleBack">
    ...
    <div v-if="suggestion" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div class="bg-white dark:bg-gray-800 rounded-lg p-5 flex items-center gap-4 shadow-sm border-l-4 border-green-500 md:col-span-2">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-5 flex items-center gap-4 shadow-sm border-l-4 border-blue-500">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-5 flex items-center gap-4 shadow-sm border-l-4 border-purple-500">
        <div class="w-12 h-12 rounded-lg bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 flex items-center justify-center">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-5 flex items-center gap-4 shadow-sm border-l-4 border-orange-500">
    ...
    <!-- 加载状态 -->
    <div v-if="loading" class="flex flex-col items-center justify-center py-20 bg-white dark:bg-gray-800 rounded-lg">
      <div class="w-16 h-16 border-4 border-blue-600 border-t-transparent rounded-full animate-spin" />
    ...
    <!-- 无建议状态 -->
    <div v-else-if="!suggestion" class="flex flex-col items-center justify-center py-20 bg-white dark:bg-gray-800 rounded-lg">
    ...
    <div v-else class="flex flex-col gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            <!-- 序号 -->
            <div class="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 flex items-center justify-center font-bold text-sm flex-shrink-0">
              {{ index + 1 }}
            </div>
            ...
            <div class="flex-1 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div class="flex items-center gap-4 flex-wrap">
                <!-- 付款人 -->
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm" :style="{ backgroundColor: getMemberColor(transfer.from) }">
                ...
                <!-- 收款人 -->
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm" :style="{ backgroundColor: getMemberColor(transfer.to) }">
              ...
              <div class="flex items-baseline gap-2">
                <span class="text-xl font-bold text-gray-900 dark:text-gray-100">¥{{ formatAmount(transfer.amount) }}</span>
            ...
            <div class="flex items-center">
              <span class="px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300">待执行</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          ...
          <button class="text-sm text-blue-600 dark:text-blue-400 hover:underline" @click="toggleVisualization">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6">
          <div class="flex-1 max-w-xs p-4 rounded-lg border-2 border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20">
            ...
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ originalTransferCount }}</span>
              </div>
              <div class="flex items-center justify-between">
          ...
          <div class="flex-1 max-w-xs p-4 rounded-lg border-2 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20">
            <div class="flex items-center gap-2 font-medium mb-3 text-green-700 dark:text-green-300">
            ...
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-600 dark:text-gray-400">转账次数</span>
                <span class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ suggestion.totalTransfers }}</span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-600 dark:text-gray-400">复杂度</span>
        ...
        <div class="mt-4 flex items-center justify-center gap-2 text-green-700 dark:text-green-300 font-medium">
