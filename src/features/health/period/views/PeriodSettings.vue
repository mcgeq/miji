<script setup lang="ts">
  ...
  const calculatedStats = computed(() => {
    ...
    if (cycles.length >= 2) {
      ...
      const variance =
        cycles.reduce((sum, cycle) => sum + (cycle - average) ** 2, 0) / cycles.length;
  ...
  async function handleFileImport(event: Event) {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : '文件格式错误或数据损坏';
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      <Card shadow="md" padding="lg" hoverable>
        ...
        <div class="space-y-6">
          ...
          <!-- 智能分析卡片 -->
          <div
            v-if="periodStore.periodRecords.length >= 2"
            class="mt-4 p-4 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg"
          >
            ...
            <div class="space-y-2">
              ...
              <div class="flex justify-between items-center text-xs">
                ...
                <span class="font-medium text-gray-900 dark:text-white"
                  >{{ periodStore.periodRecords.length }}个周期</span
                >
              </div>
              <div class="flex justify-between items-center text-xs">
      ...
      <Card shadow="md" padding="lg" hoverable>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div class="space-y-2">
            ...
            />
            <p class="text-xs text-gray-500 dark:text-gray-400 ml-1">在经期开始前几天发送提醒</p>
          </div>
          ...
          <div class="space-y-2">
            <Switch
              ...
              @update:model-value="updateSettings"
            />
            <p class="text-xs text-gray-500 dark:text-gray-400 ml-1">在排卵期到来时发送提醒</p>
          </div>
          ...
          <div class="space-y-2">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">在经期开始前多少天发送提醒</p>
          </div>
        </div>
      </Card>
    </div>
        ...
        <div class="space-y-6">
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-3">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">导出所有经期数据到本地文件</p>
            </div>
            <div class="space-y-3">
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                导入数据
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">从JSON文件导入经期数据</p>
            </div>
          </div>
          ...
          <div class="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            />
            <p class="text-xs text-gray-500 dark:text-gray-400">删除所有经期记录，此操作不可撤销</p>
          </div>
        </div>
      </Card>
    </div>
    ...
    >
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">{{ importMessage }}</p>
        </div>
        <button
