  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const record: PeriodDailyRecordCreate = {
        periodSerialNum: props.record?.periodSerialNum || '',
        date: formData.date,
  ...
  >
    ...
    <FormRow :label="t('period.fields.waterIntake')" :error="getFieldErrors('waterIntake')[0]">
      <div class="flex flex-col gap-2 w-full">
        ...
        />
        <PresetButtons v-model="formData.waterIntake" :presets="WATER_PRESETS" suffix="ml" />
      </div>
    </FormRow>
    ...
    <FormRow :label="t('period.fields.sleepHours')" :error="getFieldErrors('sleepHours')[0]">
      <div class="flex flex-col gap-2 w-full">
        ...
        />
        <PresetButtons v-model="formData.sleepHours" :presets="SLEEP_PRESETS" suffix="h" />
      </div>
    </FormRow>
