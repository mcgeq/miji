...
<template>
  ...
  >
    ...
    <template #header>
      <div
        class="flex items-center justify-between gap-2.5" :class="[
      ...
      >
        ...
        <div class="flex items-center gap-2.5">
          ...
          <h3 class="text-base font-bold m-0" :class="[colorClasses.title]">
            {{ title }}
          </h3>
        </div>
        ...
        <span
          v-if="helpText"
          class="text-xs" :class="[colorClasses.helpText]"
        >
          {{ helpText }}
        </span>
      </div>
