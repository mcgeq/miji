...
<template>
  <div class="flex items-center justify-center min-h-screen p-4 bg-gray-50 dark:bg-gray-900">
    <div
      class="w-full max-w-md p-6 sm:p-8 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl backdrop-blur-sm flex flex-col gap-6"
    >
      <!-- 标题 -->
      ...
      <p class="text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <router-link
          to="/auth/login"
          class="ml-1 text-blue-600 dark:text-blue-400 font-medium hover:underline"
        >
          {{ t('auth.login') }}
        </router-link>
      </p>
      ...
      <p
        v-if="success"
        class="text-sm font-semibold text-center text-green-600 dark:text-green-400 select-text"
      >
