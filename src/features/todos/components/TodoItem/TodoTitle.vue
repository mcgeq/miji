  ...
  <div class="relative block flex-1 min-w-0 max-w-full overflow-hidden">
    ...
    <Teleport to="body">
      <div
        ...
        @click="hideFullTitle"
      >
        <div class="bg-base-100 dark:bg-base-200 rounded-2xl p-8 md:p-6 max-w-[90%] md:max-w-[95%] max-h-[80%] shadow-2xl text-center">
          <h3 class="text-xl md:text-lg leading-7 md:leading-6 text-neutral dark:text-neutral m-0 mb-4 break-words">
            {{ title }}
          </h3>
          <p class="text-sm text-neutral-content dark:text-neutral-content m-0">
            点击任意位置关闭
          </p>
        </div>
      </div>
