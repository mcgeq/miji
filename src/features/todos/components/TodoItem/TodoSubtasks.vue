...
<template>
  <div class="relative">
    ...
    <div class="relative">
      ...
      <div
        v-if="hasSubtasks"
        class="absolute bottom-0 left-0 right-0 h-0.5 bg-white/30 dark:bg-gray-700/30 rounded-b-lg"
      >
        <div
    ...
    <!-- 子任务模态框 -->
    <Modal :open="showModal" title="子任务" size="lg" :show-footer="false" @close="closeModal">
      <template #header>
        <div class="flex items-center justify-between w-full">
          <h3 class="text-xl font-semibold">子任务</h3>
      ...
      <div class="space-y-4">
        ...
        <div v-if="hasSubtasks" class="space-y-3">
          ...
          <div class="space-y-2">
            ...
            >
              <!-- 编辑模式 -->
              <div
                v-if="editingSubtask?.serialNum === subtask.serialNum"
        ...
        <div v-else class="text-center py-8 text-gray-400 dark:text-gray-500">
          ...
          <p class="text-sm">还没有子任务</p>
          <p class="text-xs mt-1">点击“添加子任务”开始创建</p>
        </div>
      </div>
    </Modal>
  </div>
