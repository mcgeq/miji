<script setup lang="ts">
  ...
  // Backend data structure uses desktop/mobile instead of system
  type BackendReminderMethods = {
    desktop?: boolean;
    mobile?: boolean;
    email?: boolean;
    sms?: boolean;
  ...
  const props = defineProps<{
    todo: {
      ...
      reminderMethods: BackendReminderMethods | null;
...
<template>
  <div class="relative">
    ...
    <!-- 提醒设置模态框 -->
    <Modal :open="showModal" title="提醒设置" size="md" @close="closeModal" @confirm="saveSettings">
      <template #footer>
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-3">
            <label class="relative inline-flex items-center cursor-pointer">
              <input v-model="reminderSettings.enabled" type="checkbox" class="sr-only peer" />
              <div
          ...
          <div
            v-if="reminderSettings.enabled"
            class="space-y-4 pl-4 border-l-2 border-blue-600 dark:border-blue-400"
          >
            <!-- 提前时间设置 -->
            <div class="space-y-2">
              ...
              <div class="flex gap-2">
                ...
                />
                <select
                  v-model="reminderSettings.advanceUnit"
        ...
        <!-- 智能提醒设置 -->
        <div class="space-y-4">
          <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300">智能提醒</h4>
          <div class="space-y-3">
            <div class="flex items-center gap-3">
              <label class="relative inline-flex items-center cursor-pointer">
                <input
                  v-model="reminderSettings.smartEnabled"
                  type="checkbox"
                  class="sr-only peer"
                />
                <div
            ...
            <div
              v-if="reminderSettings.smartEnabled"
              class="space-y-3 pl-4 border-l-2 border-green-600 dark:border-green-400"
            >
              <label class="flex items-center gap-3 cursor-pointer">
                <input
                  v-model="reminderSettings.locationBased"
                  type="checkbox"
                  class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400"
                />
              ...
              <label class="flex items-center gap-3 cursor-pointer">
                <input
                  v-model="reminderSettings.weatherDependent"
                  type="checkbox"
                  class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400"
                />
              ...
              <label class="flex items-center gap-3 cursor-pointer">
                <input
                  v-model="reminderSettings.priorityBoost"
                  type="checkbox"
                  class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400"
                />
